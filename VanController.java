...
public class VanController {
   ...
   @PostMapping("/logup/insert") // 회원가입 세부사항
   public String logupInsert(String id, String password, String username, String email, RedirectAttributes re) {
   ...
   @GetMapping("/book") // 예매율 페이지
   public String book(HttpSession se, Model mo) {
	   mo.addAttribute("id", se.getAttribute("id"));
	   return "book";
   }
   ...
   public String logout(HttpSession se, Model mo, RedirectAttributes re) {
     ...
     re.addAttribute("msg", id+"님, 로그아웃되었습니다.");
     se.invalidate();
     re.addAttribute("url", "/home");
     return "redirect:/popup";
   }
